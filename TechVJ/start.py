...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "https://t.me/PrimeCoreHQ")
    ],[
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+iMGAGkDqiaRlMjVl'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Anicore_Animes)
    ]]
